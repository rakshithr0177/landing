            ...
            <div className="home stickey flex flex-col w-[100%]">
                ...
                >
                    <div className="wrapper1">
                        {/* first container */}
                        <div className="first h-[80%] p-[1rem] w-[100%] flex items-center justify-center " data-aos='fade-up '
                        >
                            <div className='flex flex-col justify-end w-2/5 text-center'>
                                <h1 className='uppercase text-3xl' data-aos='fade-up'>Are you studying in college and not yet placed !!!</h1>
                            </div>
                        ...
                        {/* second container */}
                        <div className="second h-[80%]  p-[1rem] w-[80%] flex items-center justify-center " data-aos='fade-up ' >
                            <div className="w-64 m-12">
                                <Lottie
                                    animationData={worried}
                                    loop={true}
                                />
                            </div>
                        ...
                        {/* third container */}
                        <div className="third h-[80%]  p-[1rem] w-full flex flex-col items-center justify-center " data-aos='fade-up '>
                ...
                {/* fourth container */}
                <div className="fourth h-[11rem]  p-[10rem] w-full text-center bg-red-600 text-[#ffff] flex items-center justify-center flex-col  " data-aos='fade-up '>
                    <h2 className='text-4xl  w-[100%] ' data-aos='fade-up ' >
                        Introducing 
                    </h2>
                    <h2 className='text-7xl font-bold w-[100%] pt-[2rem]' data-aos='fade-up' >
                        Job-bie
                    </h2>
                </div>
                    ...
                    <div className="wrapper2">
                        ...
                        <div className='fifth h-[80%] p-[1rem] w-[80%] flex items-center justify-center'>
                            ...
                            <div className='flex flex-col justify-end w-50%'>
                                <h1 className='text-3xl  w-[100%] uppercase text-center' data-aos='fade-up'>
                        ...
                        <div className='sixth h-[80%] p-[1rem] w-[80%] flex items-center justify-center'>
                            <div className='flex flex-col justify-end w-full text-start'>
                                ...
                                <h4 className='text-2xl w-[100%]
                        pt-4' data-aos='fade-left'>
                        ...
                        {/* text2 container */}
                        <h2 className='text2 text-5xl font-bold  w-[100%] text-center' data-aos='fade-up '>
                        ...
                        <div className='seventh h-[100%] p-[1rem] w-[80%] flex flex-col items-center justify-center mt-10 mb-10'>
                            <div className='flex flex-col justify-end w-full text-center'>
                                <h2 className='text-4xl font-bold w-[100%] pt-7 ' data-aos='fade-up'>
                                    Apply to your dream job and get placed now
                                </h2>
                            </div>
                            <div className="btn">
                                <button
                                    className='w-[12rem] h-[4rem] bg-red-500 text-2xl mt-[3rem]  rounded-[1rem] text-center ' data-aos='fade-up'
